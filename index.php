...
?>
        ...
        <div class="container mx-auto px-4">
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div class="order-2 lg:order-1">
                    <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 h-64 flex items-center justify-center">
                        <div class="text-center">
                ...
                <div class="order-1 lg:order-2">
                    <h2 class="text-4xl font-bold text-gray-800 mb-6">Automate appointment booking & reminders</h2>
                    <p class="text-xl text-gray-600 mb-8">Healthcare clinics, beauty salons, dealerships, and other service providers often have to juggle appointment scheduling. AI voice agents can connect with any live calendar and automate all routine calls.</p>
    ...
    <section class="py-20 bg-white fade-in-section">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                <h2 class="text-4xl font-bold text-gray-800 mb-4">Endless use cases</h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">Easily create and customize AI voice agents to handle any scenario your business needs—no coding required.</p>
            </div>

            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-2xl text-center hover:shadow-lg transform transition hover:scale-105 duration-300">
                    <div class="w-16 h-16 mx-auto mb-6 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-full flex items-center justify-center">
                ...
                <div class="bg-gradient-to-br from-green-50 to-emerald-50 p-8 rounded-2xl text-center hover:shadow-lg transform transition hover:scale-105 duration-300">
                    <div class="w-16 h-16 mx-auto mb-6 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full flex items-center justify-center">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-gradient-to-br from-purple-50 to-pink-50 p-8 rounded-2xl text-center hover:shadow-lg transform transition hover:scale-105 duration-300">
                    <div class="w-16 h-16 mx-auto mb-6 bg-gradient-to-r from-purple-500 to-pink-600 rounded-full flex items-center justify-center">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-gradient-to-br from-orange-50 to-red-50 p-8 rounded-2xl text-center hover:shadow-lg transform transition hover:scale-105 duration-300">
                    <div class="w-16 h-16 mx-auto mb-6 bg-gradient-to-r from-orange-500 to-red-600 rounded-full flex items-center justify-center">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-gradient-to-br from-teal-50 to-cyan-50 p-8 rounded-2xl text-center hover:shadow-lg transform transition hover:scale-105 duration-300">
                    <div class="w-16 h-16 mx-auto mb-6 bg-gradient-to-r from-teal-500 to-cyan-600 rounded-full flex items-center justify-center">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-gradient-to-br from-gray-50 to-slate-50 p-8 rounded-2xl text-center hover:shadow-lg transform transition hover:scale-105 duration-300">
                    <div class="w-16 h-16 mx-auto mb-6 bg-gradient-to-r from-gray-500 to-slate-600 rounded-full flex items-center justify-center">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section class="py-20 main-gradient fade-in-section">
        <div class="container mx-auto px-4 text-center">
            <div class="max-w-4xl mx-auto">
                <h2 class="text-4xl font-bold text-white mb-6">Ready to Transform Your Business Communications?</h2>
                <p class="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">Join hundreds of businesses already using Alivio247 to automate their phone calls and improve customer satisfaction.</p>

                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <button onclick="window.location.href='inbound.php'" class="bg-white text-blue-600 font-semibold py-4 px-8 rounded-full hover:bg-blue-50 transform transition hover:scale-105 duration-300 shadow-lg">
                        View Pricing
                    </button>
                    <button onclick="window.location.href='contact-us.php'" class="border-2 border-white text-white font-semibold py-4 px-8 rounded-full hover:bg-white hover:text-blue-600 transform transition hover:scale-105 duration-300">
                        Contact Sales
                    </button>
                </div>
                ...
                <div class="mt-12 grid md:grid-cols-3 gap-8 text-center">
                    ...
                    <div>
                        <h3 class="text-2xl font-bold text-white mb-2">99.9%</h3>
                        <p class="text-blue-200">Uptime Guarantee</p>
                    </div>
                    <div>
                        <h3 class="text-2xl font-bold text-white mb-2">5 Min</h3>
                        <p class="text-blue-200">Setup Time</p>
                    </div>
                </div>
            </div>
        </div>
